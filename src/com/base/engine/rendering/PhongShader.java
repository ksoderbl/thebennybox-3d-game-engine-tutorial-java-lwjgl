...
public class PhongShader extends Shader
{
    ...
    private PhongShader()
    {
        ...
        addVertexShaderFromFile("phongVertex");
        addFragmentShaderFromFile("phongFragment");
        compileShader();
        ...
        System.out.println("PhongShader constructed OK");
    }
    ...
    public static void setPointLights(PointLight[] pointLights)
    {
        ...
        {
            System.err.println("Error: You passed in too many point lights. Max allowd is " + MAX_POINT_LIGHTS
    ...
    public static void setSpotLights(SpotLight[] spotLights)
    {
        ...
        {
            System.err.println("Error: You passed in too many spot lights. Max allowd is " + MAX_SPOT_LIGHTS
